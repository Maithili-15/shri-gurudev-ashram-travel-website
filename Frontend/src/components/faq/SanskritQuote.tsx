...
export const SanskritQuote: React.FC = () => {
    ...
    <section className="py-20 md:py-28 bg-[#fffdf8] flex flex-col items-center justify-center text-center px-margin-mobile relative overflow-hidden border-t border-outline-variant/30 min-h-[55vh]">
      ...
      >
        ...
        <div className="pt-4 pb-2">
          <span className="font-display-lg text-[6rem] md:text-[7.5rem] text-transparent bg-clip-text bg-gradient-to-b from-[#e88b17] to-[#cba258] drop-shadow-sm leading-normal inline-block select-none">
            ॐ
          </span>
        </div>
        ...
        {/* Sanskrit Verse */}
        <p className="font-display-lg text-4xl sm:text-5xl md:text-6xl text-[#4a4d3a] my-8 leading-tight drop-shadow-sm px-4 select-none">
